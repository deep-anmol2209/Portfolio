...
const socialLinks = [
    ...
    // },
    {
      href: 'https://www.instagram.com/deep_anmol2209?igsh=am1jOWJkbmdudTJy',
  ...
  return (
    ...
    className="section">
        <div className="container lg:grid lg:grid-cols-2 lg:items-stretch">
            <motion.div className="mb-12 lg:mb-0 lg:flex lg:flex-col" initial='offscreen'
            ...
            variants={cardVariantsLeft}>
                ...
                <div className="flex items-center gap-2 mt-auto">
                    {socialLinks.map(({ href, icon}, key) => (
                        ...
                        href={href}
                        target='blank'
                        className="color-change-2x w-12 h-12 grid place-items-center ring-inset ring-2 ring-zinc-50/5 rounded-lg transition-[background-colo,color] hover:bg-zinc-50 hover:text-zinc-950 active:bg-zinc-50/80"
                        >
                            {icon}
                        </a>
                    ))}
            ...
            <motion.form 
            action="https://getform.io/f/bwnwemva"
            method="POST"
            className="xl:pl-10 2xl:pl-20" initial='offscreen'
            whileInView='onscreen'
            viewport={{ once: true, amount: 0 }}
